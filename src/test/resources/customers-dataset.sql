...
insert into account (id, created, updated, number, type, customer_id, balance, currency)
    values (1, '2017-03-22 14:23:25', null, 051234562313, 'SAVINGS', 1, 500000, 'EUR');
insert into account (id, created, updated, number, type, customer_id, balance, currency)
    values (2, '2017-03-22 14:23:25', null, 053248946241, 'CREDIT', 2, 200000, 'EUR');